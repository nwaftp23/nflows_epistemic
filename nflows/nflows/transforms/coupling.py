...
class CouplingTransform(Transform):
    ...
    def forward(self, inputs, context=None, kwargs=None):
        ...
        if kwargs == None:
            ...
            transform_params = self.transform_net(identity_split, context, **kwargs)
    ...
    def inverse(self, inputs, context=None, kwargs=None):
        if inputs.dim() not in [2, 4]:
            raise ValueError("Inputs must be a 2D or a 4D tensor.")
