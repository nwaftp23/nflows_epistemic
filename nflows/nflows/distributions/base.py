...
class Distribution(nn.Module):
    ...
    def log_prob(self, inputs, context=None, kwargs=None):
        ...
        return self._log_prob(inputs, context, kwargs=kwargs)

    def _log_prob(self, inputs, context):
        raise NotImplementedError()

    def sample(self, num_samples, context=None, batch_size=None, kwargs={}):
        ...
        if batch_size is None:
            if kwargs=={}:
                ...
                return self._sample(num_samples, context, kwargs=kwargs)
    ...
    def sample_and_log_prob(self, num_samples, context=None, kwargs={}):
        ...
        Returns:
            A tuple of:
                ...
                * A Tensor containing the log probabilities of the samples, with shape
                  ...
                  context is given.
        """
        samples, means, stds = self.sample(num_samples, context=context, kwargs=kwargs)
        ...
        log_prob = self.log_prob(samples, context=context, kwargs=kwargs)
        ...
        return samples, log_prob, means, stds
